...
# agent_core/controller/service.py
...
class ControllerService:
    ...
    def canvas_input(self, value):
        ...
        try:
            ...
            logger.info(f"Canvas input: typed '{value}' ({len(value)} chars)")
            return {"status": "success", "action": "canvas_input", "value": value,
