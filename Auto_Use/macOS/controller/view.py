...
from .tool import open_app, AppleScriptService
...
class ControllerView:
    ...
    def route_action(self, action_data):
        ...
        If any action fails, execution stops immediately (safety mechanism).
        
        Args:
            action_data (list): Action list e.g. [{"type": "left_click", "id": 5, "clicks": 1}]
        ...
        try:
            ...
            for action_item in action_data:
                ...
                # ==================== AppleScript ====================
                    ...
                    logger.info(f"AppleScript on {app_name}: {script_value[:80]}")
                ...
                # ==================== CLI Tools ====================
                    ...
                    if self.cli_service:
                        ...
                        old_str = action_item.get("old_str", "")
                        new_str = action_item.get("new_str", "")
                        result = self.cli_service.replace(path, line, old_str, new_str)
                        results.append(result)
                    else:
                        return {
                            "status": "error",
