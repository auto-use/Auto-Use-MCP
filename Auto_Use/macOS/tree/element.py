...
Exposes the same UIElementScanner class interface that agent_core/agent/service.py
and agent_core/controller/ expect:
...
class UIElementScanner:
    ...
    Exposes the same public interface so agent_core/agent/service.py,
    agent_core/controller/service.py, and agent_core/controller/view.py
